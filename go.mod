...
exclude github.com/cloudwego/base64x v0.1.4

exclude github.com/bytedance/sonic v1.11.6

exclude github.com/bytedance/sonic/loader v0.1.1

exclude github.com/twitchyliquid64/golang-asm v0.15.1
